...
class CommentController extends AbstractController
{
    ...
    public function add(Request $request, ArticleRepository $articleRepo, EntityManagerInterface $em, CommentRepository $commentRepo, UserRepository $userRepo): Response
    {
